/* Program: EventButtonandLEDp1.java          Last Date of this Revision: April 27th,2022

Purpose: corresponding led blinks w button
Author: Tyler Grewal 
School: CHHS
...
public class EventButtonandLEDp1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        redButton.addStateChangeListener(new DigitalInputStateChangeListener() { //attach a listener
...
/*P1
 This code has a DigitalInputStateChangeEvent and listener so it only blinks when pressed instead of going through the code and being slightly off with time like it was with lesson 3
 */
